...
const Footer = () => {
    ...
    return (
        <footer className="tw-h-[300px] tw-mt-5">
            <div className="tw-bg-[#E2CBE1] tw-text-white tw-flex tw-justify-center tw-items-center tw-h-full">
                <div className="tw-w-1/3 tw-flex tw-justify-center tw-items-center tw-gap-5">
                    <h1>
